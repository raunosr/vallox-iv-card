...
**Version 2.0.0-beta.3 — opt-in prerelease.** The card works independently. Seasonal control
...
See the [release notes](docs/releases/v2.0.0-beta.3.md) and [validation status](docs/BETA-VALIDATION.md).
...
**v2.0.0-beta.3**. Use **Update information** first if the release has not appeared yet.
