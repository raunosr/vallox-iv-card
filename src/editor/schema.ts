...
export const SECTIONS: Section[] = [
  ...
  { key:'insights',fi:'Ehdotukset',en:'Suggestions',fields:[bool('enabled','Näytä ehdotukset','Show suggestions'),select('heating_system','Talon lämmitystapa','Home heating system',['unknown','heat_pump','district_heating','other_efficient','electric']),number('daily_budget_kwh','Oma kulutustavoite (kWh/vrk), valinnainen','Your daily energy budget (kWh), optional',.1,1000,.1),number('comfort_floor','Oma mukavuusraja (°C), valinnainen','Your comfort floor (°C), optional',-50,50,.5),number('excess_ratio','Vertailutason ylitys (0,5 = 50 %)','Excess over baseline (0.5 = 50%)',.01,10,.01),number('defrost_minutes','Pitkän sulatuksen havaintoraja (min)','Long defrost observation threshold (min)',1,1440)] },
